    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link" data-target="#faqur" data-toggle="modal">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="<?= base_url('vim/data_vim/updated') ?>" method="POST">
                        <div class="row">
                            <div class="col-md-5 pr-5">
                                <?php foreach ($data as $dt) : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" id="exampleInputPassword1" placeholder="" name="id" value="<?= $dt->id_vim ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="software" value="<?= $dt->software ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-right">
                                        <a href="<?= base_url('data_vim') ?>" class="btn btn-danger">Batal</a>
