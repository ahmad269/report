          ...
          <aside class="main-sidebar sidebar-dark-primary elevation-4">
              ...
              <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                          ...
                          <li class="nav-item">
                              <a href="<?= base_url('backup_data') ?>" class="nav-link">
              ...
              <section class="content">
                  <div class="container-fluid ">
                      ...
                      <div class=" text-uppercase">
                          <h4 class="text-bold text-muted">Total Data dan user</h4>
                      </div>
                      <div class="row  mb-1">
                          <div class=" col-lg-3 col-6">
                              ...
                              <div class="small-box bg-info">
                                  ...
                                  <a href="<?= base_url('data_report') ?>" class="small-box-footer">Info Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                          </div>
                          <!-- ./col -->
                          <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-success">
                                  ...
                                  <a href="<?= base_url('data_user') ?>" class="small-box-footer">Info Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                          </div>
                          <div class="col-lg-3 col-6">
                              <!-- small box -->
                              <div class="small-box bg-warning">
                                  ...
                                  <a href="<?= base_url('data_ur') ?>" class="small-box-footer">Info Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                          </div>
                          ...
                          <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-primary">
                                  ...
                                  <a href="<?= base_url('data_vim') ?>" class="small-box-footer">Info Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                          </div>
                      ...
                      <div class="text-uppercase text-muted">
                          <h4 class="text-bold">Data Report </h4>
                      </div>
                      <div class="row">
