    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="<?= base_url('vim/file_vim/updated') ?>" method="POST">
                        <div class="row">
                            <div class="col-md-5 pr-5">
                                <?php foreach ($data as $dt) : ?>
                                    ...
                                    <div class="form-group">
                                        <label>line</label>
                                        <input type="hidden" class="form-control" id="exampleInputPassword1" placeholder="" name="id" value="<?= $dt->id_filevim ?>">
                                        <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" name="line">

                                            <option selected="selected"><?= $dt->line ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" name="model" value="<?= $dt->model ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">filse</label>
                                    ...
                                    <div class="text-right">
                                        <a href="<?= base_url('file_vim') ?>" class="btn btn-danger">Batal</a>
