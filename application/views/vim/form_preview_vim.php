...
<body>
    <div class="container-fluid">
        ...
        <h3 class="pt-5 text-danger text-center text-uppercase">Form Impor File VIM</h3>
        <hr>
        <p>Hallo <span class="text-uppercase text-bold"><?= $user['nama'] ?></span></p>
        <p>Ini adalah form import data FIle VIM</p> Silahkan terlebih dahulu mendownload format FIle VIM.
        <div class="mt-2">
            <a class="btn btn-block btn-success" href="<?= base_url('material/myreport/file_data/filevim/format_file_vim.xlsx') ?>"><i class="fas fa-file-excel mr-2"></i> Download Format</a>
        </div>
        <hr class="pt-2 pb-2">
        <!-- Buat sebuah tag form dan arahkan action nya ke controller ini lagi -->
        <form method="post" action="<?php echo base_url("vim/file_vim/form_vim"); ?>" enctype="multipart/form-data">
            <!-- 
    ...
    -->
        ...
        if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form 
            ...
            echo "<form method='post' action='" . base_url("vim/file_vim/import") . "'>";
