                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <?php echo  form_open('admin/data_report/filter', "class='form-inline'") ?>
                                <label for="email"> </label>
                                <input type="date" class="form-control mr-2" name="aw" id="aw" value="<?php echo !empty($dat1) ? $dat1 : '' ?>" required>
                                <label for="pwd"></label>
                                <input type="date" class="form-control mr-2" name="akh" value="<?php echo !empty($dat2) ? $dat2 : '' ?>" id="akh" required>
                                ...
                                <div class="table-responsive">
                                    <div class="mb-3 text-center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-warning" href="#" onclick="export_excel()"><i class="fas fa-file-excel"></i> Export Excell</a>
                                            <a class="btn btn-info" onclick="refresh_report()"><i class="fas fa-sync"></i> Refresh</a>
                                    ...
                                    <form action="<?= base_url('admin/data_report/remove') ?>" method="POST">
                                        <table data-uri="<?= $uri ?>" class="table table-bordered table-hover table-striped dt-responsive nowrap tabel" style="width : 100%;">
                                            <thead>
                                                <tr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="date_report" placeholder="" name="date" required aria-readonly="true" readonly>
                        ...
                        <table class="table table-striped table-hover " width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <th>Problem</th>
                                    <td>
                                        <textarea class="form-control" name="" id="problem" cols="20" rows="3" disabled></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Cause</th>
                                    <td>
                                        <textarea class="form-control" name="" id="cause" cols="20" rows="3" disabled></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Action</th>
                                    <td>
                                        <textarea class="form-control" style="outline: none" name="" id="action" cols="3" rows="5" aria-disabled="true" disabled></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Note</th>
                                    <td>
                                        <textarea class="form-control" name="" id="note" cols="20" rows="3" disabled></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
