<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('file_vim') ?>" class="nav-link active">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Table File VIM</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
							<div class="table-responsive">
                                <div class="mb-3 text-center">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn btn-primary" data-toggle="modal" data-target="#modal-file-vim"><i class="fas fa-plus"></i> Tambah FIle VIM</button>
                                        <a class="btn btn-success" href="<?= base_url('import_file_vim') ?>"><i class="fas fa-upload"></i> Import</a>
                                        <a class="btn btn-warning" href="<?= base_url('export_file_vim') ?>"><i class="fas fa-file-excel"></i> Export Excell</a>
                                ...
                                <form action="<?= base_url('vim/file_vim/remove') ?>" method="post">
                                       <table id="table_filter" class="table table-bordered table-hover table-striped display" widh="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($file_vim as $filevim) : ?>
                                                <tr>
                                                    <td><input type="checkbox" class="check-item" name="id_filevim[]" value="<?php echo $filevim->id_filevim ?>"></td>
                                                    <td><?= $no++ ?></td>
                                                    <td><?= $filevim->line ?></td>
                                                    <td><?= $filevim->model ?></td>
                                                    <td><?= $filevim->file ?></td>
                                                    <td>
                                                        <a href="<?= base_url('vim/file_vim/edit_file_vim/' . $filevim->id_filevim) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"> Edit</i></a>
                                                        <a href="<?= base_url('vim/file_vim/hapus_file_vim/' . $filevim->id_filevim) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class=" fa fa-trash"> Delete</i></a>
                                                    </td>
        ...
        <div class="modal fade" id="modal-file-vim" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('vim/file_vim/tambah_file_vim') ?>" method="POST">
                            <div class="row">
                                <div class="col-md">
