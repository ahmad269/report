<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('file_ur') ?>" class="nav-link active">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Table File UR</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
							<div class="table-responsive">
                                <div class="mb-3 text-center ">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn btn-primary" data-toggle="modal" data-target="#modal-file-ur"><i class="fas fa-plus"></i> Tambah FIle UR</button>
                                        <a class="btn btn-success" href="<?= base_url('import_file_ur') ?>"><i class="fas fa-upload"></i> Import</a>
                                        <a class="btn btn-warning" href="<?= base_url('export_file_ur') ?>"><i class="fas fa-file-excel"></i> Export Excell</a>
                                ...
                                <form action="<?= base_url('ur/file_ur/remove') ?>" method="post">
                                    <table id="table_filter" class="table table-bordered table-hover table-striped display" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($file_ur as $fileur) : ?>
                                                <tr>
                                                    <td><input type="checkbox" class="check-item" name="id_fileur[]" value="<?php echo $fileur->id_fileur ?>"></td>
                                                    <td><?= $no++ ?></td>
                                                    <td><?= $fileur->line ?></td>
                                                    <td><?= $fileur->model ?></td>
                                                    <td><?= $fileur->file ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('ur/file_ur/edit_file_ur/' . $fileur->id_fileur) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"> Edit</i></a>
                                                        <a href="<?= base_url('ur/file_ur/hapus_file_ur/' . $fileur->id_fileur) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class=" fa fa-trash"> Delete</i></a>
                                                    </td>
        ...
        <div class="modal fade" id="modal-file-ur" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('ur/file_ur/tambah_file_ur') ?>" method="POST">
                            <div class="row">
                                <div class="col-md">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="file" required>
                                    </div>
        ...
        <!-- MODAL GUIDE -->
        <div class="modal fade" id="guide_ur">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <embed src="material/myreport/pdf/WI_UR.pdf" type="application/pdf" width="100%" height="700px" />
                </div>
                <!-- /.modal-content -->
            </div>
            <!-- /.modal-dialog -->
