<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('data_ur') ?>" class="nav-link active">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Table Data UR</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
							<div class="table-responsive">
                                <div class="mb-3 ">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn btn-primary mr-2" data-toggle="modal" data-target="#modal-ur"><i class="fas fa-plus"></i> Tambah UR</button>
                                ...
                                <form action="<?= base_url('ur/data_ur/remove') ?>" method="POST">
                                    <table id="table_filter" class="table table-bordered table-hover table-striped display" widh="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($data_ur as $ur) : ?>
                                                <tr>
                                                    <td><input type="checkbox" class="check-item" name="id_ur[]" value="<?php echo $ur->id_ur ?>"></td>
                                                    <td><?= $no++ ?></td>
                                                    <td><?= $ur->serial ?></td>
                                                    <td><?= $ur->name ?></td>
                                                    <td><?= $ur->file ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('ur/data_ur/edit_ur/' . $ur->id_ur) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"> Edit</i></a>
                                                        <a href="<?= base_url('ur/data_ur/hapus_ur/' . $ur->id_ur) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class=" fa fa-trash"> Delete</i></a>
                                                    </td>
                                        ...
                                        <script type="text/javascript">
                                            function toggle(pilih) {
                                                checkboxes = document.getElementsByName('id_ur[]');
        ...
        <div class="modal fade" id="modal-ur" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url('ur/data_ur/tambah_ur') ?>" method="POST">
                            <div class="row">
                                <div class="col-md">
        ...
        <div class="modal fade" id="guide_ur">
            <div class="modal-dialog modal-xl">
                <div class=" modal-content">
                    ...
                    <embed src="material/myreport/pdf/WI_UR.pdf" type="application/pdf" height="700px" />
                </div>
                <!-- /.modal-content -->
            </div>
            <!-- /.modal-dialog -->
