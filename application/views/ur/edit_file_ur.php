    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <form action="<?= base_url('ur/file_ur/updated') ?>" method="POST">
                        <div class="row">
                            <div class="col-md-5 pr-5">
                                <?php foreach ($data as $dt) : ?>
                                    ...
                                    <div class="form-group">
                                        <label>line</label>
                                        <input type="hidden" class="form-control" id="exampleInputPassword1" placeholder="" name="id" value="<?= $dt->id_fileur ?>">
                                    ...
                                    <div class="text-right">
                                        <a href="<?= base_url('file_ur') ?>" class="btn btn-danger">Batal</a>
