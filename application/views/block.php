...
<body>
    ...
    <div class="errortext">Anda tidak memiliki akses ke halaman ini</div> <br>
    <div class="errortext"> <button class="tombol" type="button" value="" onclick="history.back(-1)">Kembali</button></div>
